    ...
    <section className="mx-auto max-w-5xl px-6 py-12">
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/learn" className="group h-full">
          <div className="rounded-2xl p-[1px] h-full transition-all duration-300 group-hover:shadow-lg group-hover:shadow-primary/10"
        ...
        <Link href="/problems" className="group h-full">
          <div className="rounded-2xl p-[1px] h-full transition-all duration-300 group-hover:shadow-lg group-hover:shadow-primary/10"
            style={{ background: "var(--qv-gradient-card)" }}
          >
            <div className="rounded-2xl bg-card p-6 h-full flex flex-col gap-5">
        ...
        {/* Learn Excel Card */}
        <Link href="/excel" className="group h-full">
          <div className="rounded-2xl p-[1px] h-full transition-all duration-300 group-hover:shadow-lg group-hover:shadow-primary/10"
            style={{ background: "var(--qv-gradient-card)" }}
          >
            <div className="rounded-2xl bg-card p-6 h-full flex flex-col gap-5">
